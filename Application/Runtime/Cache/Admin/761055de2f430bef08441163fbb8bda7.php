...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/sunshine/index.php/Admin/Article/lst">文章管理</a><span class="crumb-step">&gt;</span><span>修改文章</span></div>
        </div>
                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($articleer["title"]); ?>" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>文章描述：</th>
                                <td>
                                    <textarea style="width:420px;height: 100px;"name="desc" value=""><?php echo ($articleer["desc"]); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
									...
									<?php if($articleer['pic'] != null): ?><img src="/sunshine<?php echo ($articleer["pic"]); ?>" height="50">		<!--/sunshine:根目录-->
										<?php else: ?>
										无图片<?php endif; ?>	
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                   <select name="cateid">
                                   	<option>选择分类</option>
                                   	<?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $articleer[cateid]): ?>selected="selected"<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></option>
                                   			<!--为了显示原来的标题的--><?php endforeach; endif; else: echo "" ;endif; ?>
                                   </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <textarea name="content" id="content"><?php echo ($articleer["content"]); ?></textarea><!--引入外部编辑器-->
                                </td>
                            </tr>
                            <tr>
                                <th></th>
